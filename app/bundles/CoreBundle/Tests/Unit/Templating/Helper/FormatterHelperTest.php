    ...
    public function urlFormatProvider(): array
    {
        return [
            ...
            'malicious url' => [
                ...
                '<a href="http://example.com&#34;&#62;&#60;script&#62;alert(&#34;XSS&#34;)&#60;/script&#62;" target="_new">http://example.com&#34;&#62;&#60;script&#62;alert(&#34;XSS&#34;)&#60;/script&#62;</a>',
            ],
            'malicious url2' => [
                'http://example.com?a="<b>test</b>',
                '<a href="http://example.com?a=%22%3Cb%3Etest%3C%2Fb%3E" target="_new">http://example.com?a=%22%3Cb%3Etest%3C%2Fb%3E</a>',
            ],
            'url with single GET parameter' => [
                'http://example.com/page?param=value',
                '<a href="http://example.com/page?param=value" target="_new">http://example.com/page?param=value</a>',
            ],
            'url with multiple GET parameters' => [
                'http://example.com/search?q=test&page=1&sort=desc',
                '<a href="http://example.com/search?q=test&page=1&sort=desc" target="_new">http://example.com/search?q=test&page=1&sort=desc</a>',
            ],
            'url with encoded GET parameters' => [
                'http://example.com/search?q=hello+world&lang=en',
                '<a href="http://example.com/search?q=hello+world&lang=en" target="_new">http://example.com/search?q=hello+world&lang=en</a>',
            ],
            'url with special characters in GET parameters' => [
                'http://example.com/path?param=value&special=!@#$%^&*()',
                '<a href="http://example.com/path?param=value&special=%21%40#$%^&*()" target="_new">http://example.com/path?param=value&special=%21%40#$%^&*()</a>',
            ],
            'https url' => [
                'https://secure.example.com',
                '<a href="https://secure.example.com" target="_new">https://secure.example.com</a>',
            ],
            'url with port number' => [
                'http://example.com:8080/path',
                '<a href="http://example.com:8080/path" target="_new">http://example.com:8080/path</a>',
            ],
            'url with username and password' => [
                'http://user:pass@example.com',
                '<a href="http://user:pass@example.com" target="_new">http://user:pass@example.com</a>',
            ],
            'url with fragment identifier' => [
                'http://example.com/page#section',
                '<a href="http://example.com/page#section" target="_new">http://example.com/page#section</a>',
            ],
        ];
    }
